...
# renaming variables to match the cc.dta dataset

# DO WE NEED TO SELECT .... Yes you need to select otherwise the data sets wont merge. 
cc2_data <- cc2_data %>%
...
**Code:**
```{R}
# DO WE NEED TO SELECT (WILL ASK TA tomorrow) .... Yes you need to select otherwise the data sets wont merge. 
cc2_data <- cc2_data %>%
...
This question is missing the second part (WILL CHECK WITH TA tomorrow)
```{r}
# QUESTION: 10561 observations? in combined_data
